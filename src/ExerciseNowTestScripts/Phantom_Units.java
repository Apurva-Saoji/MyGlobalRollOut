...
public class Phantom_Units extends MyEsopsLogin {

	public void Phantom_Units_Method() throws Exception {

		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);

		test = report.startTest("Exerciese Phantom Units Payment Mode");
		...
		if (Exerciese_Options == true) {
			...
			Thread.sleep(500);
			test.log(LogStatus.FAIL, " Test Case Failed:-" + Exerciese_Options);
...
//			wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("btn-link1")));		 
//			JavascriptExecutor executor25 = (JavascriptExecutor) driver;
//			executor25.executeScript("arguments[0].click();", wait);
		...
		for (int s = 1; s <= GetCount_Title.size(); s++) {
			...
			String ExerciseOptions = driver
					.findElement(
							By.xpath(".//kt-excercise-stock-list/div[2]/div[3]/div[" + s + "]/div/div[1]/div[1]/h3"))
					.getText();
			System.out.println("ExerciseOptions Titles--->" + ExerciseOptions);

			if (ExerciseOptions.equals("Phantom Units")) {
				...
				if (Exercise_ProceedToExercise == true) {
					...
					driver.findElement(By.xpath(
							"//kt-excercise-stock-list/div[2]/div[3]/div[" + s + "]/div/div[1]/div[2]/div/button"))
							.click();
					System.out.println("Click on the Exercise Proceed To Exercise ");
					Thread.sleep(500);
					test.log(LogStatus.PASS,
							"Click on the Exercise Proceed To Exercise :-" + Exercise_ProceedToExercise);
				...
				Boolean StockOptions_QuickNotes = driver.findElements(By
						.xpath("//*[@id='kt_content']/div/kt-excercise-stock-proceed-exercise/div[1]/div[1]/h2/button"))
						.size() != 0;
				...
				if (Quantity_Enter.isEnabled()) {
					...
					Boolean Quantity_Enter2 = driver
							.findElements(
									By.xpath("//div[2]/div[1]/div/div/div[2]/div/table/tbody/tr[1]/td[2]/div/input"))
							.size() != 0;
					...
					if (Calculate_Button.isEnabled()) {
						...
						if (Calculate_Button2 == true) {
							...
							if (Tax_Amount == true) {
								...
								System.out.println(" Click on the Tax_Amount Button close03");
								Thread.sleep(2000);
								...
								String GetAmount_Titile12 = driver.findElement(By.xpath(
										"//*[@id='kt_content']/div/kt-excercise-stock-proceed-exercise/div[2]/div/div[2]/div/div/div/table/tbody[1]/tr[2]/td[1]/ul/li/span/span"))
										.getText();
								...
								test.log(LogStatus.PASS, " Click on the Continue Button :-" + Exerciese_Options);
								Thread.sleep(3000);

								ExerciseNow_Locator.Tax_Amount_Button(driver).sendKeys(Keys.ENTER);
								System.out.println(" Click on the Tax_Amount Button");
								test.log(LogStatus.PASS, "Click on the Tax_Amount Button:-" + Exerciese_Options);
								...
								ExerciseNow_Locator.Tax_Amount_Button_Close(driver).sendKeys(Keys.ENTER);
								System.out.println(" Click on the Tax_Amount Button close01");
								test.log(LogStatus.PASS,
										" Click on the Tax_Amount Button close01:-" + Exerciese_Options);
								Thread.sleep(2000);
								...
								if (GetAmount_Titile12.equals(GetAmount_Titile23)) {
									...
									test.log(LogStatus.PASS, "Stock Appreciation:- " + GetAmount_Titile23);

								} else {
									System.err.println(GetAmount_Titile23 + ":- FAIL");
									test.log(LogStatus.FAIL, "Stock Appreciation:- " + GetAmount_Titile23);
								...
								if (GetAmount_Titile12A.equals(GetAmount_Titile23A)) {
									...
									test.log(LogStatus.PASS, "Stock Appreciation:- " + GetAmount_Titile23A);

								} else {
									System.err.println(GetAmount_Titile23A + ":- FAIL");
									test.log(LogStatus.FAIL, "Stock Appreciation:- " + GetAmount_Titile23A);
								...
								if (GetAmount_Titile14.equals(GetAmount_Titile25)) {
									...
									test.log(LogStatus.PASS, "Tax Amount:- " + GetAmount_Titile25);

								} else {
									System.err.println(GetAmount_Titile25 + ":- FAIL");
									test.log(LogStatus.FAIL, "Tax Amount:- " + GetAmount_Titile25);
								...
								if (GetAmount_Titile14A.equals(GetAmount_Titile25A)) {
									...
									test.log(LogStatus.PASS, "Tax Amount:- " + GetAmount_Titile25A);

								} else {
									System.err.println(GetAmount_Titile25A + ":- FAIL");
									test.log(LogStatus.FAIL, "Tax Amount:- " + GetAmount_Titile25A);
								...
								if (FMV == true) {
									...
									test.log(LogStatus.FAIL, "Click on the Exerciese Options :-" + Exerciese_Options);
									...
									if (ExerciseStockProceed_checkbox == true) {
										...
										Thread.sleep(500);
										test.log(LogStatus.FAIL,
												"Not Click on the ExerciseStockProceed checkbox Button:-"
														+ ExerciseStockProceed_checkbox);
									...
									if (Quantity_ConfirmExercise.isEnabled()) {
										...
										if (Quantity_ConfirmExercise2 == true) {
											...
											test.log(LogStatus.PASS,
													"Click on the Exerciese Options :-" + Exerciese_Options);
											Thread.sleep(2000);
											...
											if (Quantity_PopUp == true) {
												...
												Thread.sleep(500);
												test.log(LogStatus.FAIL,
														"Not Click on the Confirm Exercise Button:-" + Quantity_PopUp);
									...
									test.log(LogStatus.PASS, "FVM Updated :-" + FMV);
									...
									if (Quantity_ConfirmExercise.isEnabled()) {
										...
										if (Quantity_ConfirmExercise2 == true) {
											...
											if (Quantity_PopUp == true) {
												...
												System.out.println("Click on the Quantity Submit Button");
												test.log(LogStatus.PASS,
														"Click on the Exerciese Options :-" + Quantity_PopUp);
												Thread.sleep(2000);
											...
											if (Quantity_MessageText == true) {
												...
												for (int i = 1; i <= 4; i++) {
													...
													String GetAmount_TitileExercise_Declaration1 = driver.findElement(
															By.xpath("//*[@id='collapse0']/div/table/thead/tr/th[" + i
																	+ "]"))
															.getText();
															...
															String GetAmount_TitileExercise_Declaration3 = driver
																	.findElement(By.xpath(
																			"//*[@id='collapse0']/div/table/tbody/tr["
																					+ m + "]/td[" + k + "]"))
																	.getText();
															rowhead703.createCell(k).setCellValue(
																	GetAmount_TitileExercise_Declaration3);
															Thread.sleep(100);
															...
															String GetAmount_TitileExercise_Declaration4 = driver
																	.findElement(By.xpath(
																			"//*[@id='collapse0']/div/table/tbody/tr["
																					...
																					+ l + "]"))
																	.getText();
															rowhead703.createCell(4 + l).setCellValue(
																	GetAmount_TitileExercise_Declaration4);
														}
															...
															String GetAmount_TitileExercise_Declaration4 = driver
																	.findElement(By.xpath(
																			"//*[@id='collapse0']/div/table/tbody/tr["
																					...
																					+ "]/td[" + l + "]"))
																	.getText();
															rowhead705.createCell(4 + l).setCellValue(
																	GetAmount_TitileExercise_Declaration4);
												...
												HSSFRow rowhead706 = sheet7.createRow(
														(getCountExercise_Declaration * getCountExercise_Declaration2)
																+ 3);

												for (int n = 1; n < 4; n++) {

													String GetAmount_TitileExercise_Declaration6 = driver.findElement(
															By.xpath("//*[@id='collapse0']/div/table/tfoot/tr/td[" + n
																	+ "]"))
															.getText();
												...
												ExerciseNow_Locator.Tax_Amount_Button_Close(driver)
														.sendKeys(Keys.ENTER);
												System.out.println(" Click on the Tax_Amount Button close02");
												...
												// Quantity
												String GetAmount_Titile42 = driver.findElement(By.xpath(
														"//*[@id='kt_content']/div/kt-excercise-stock-payment1-iii/div[2]/div/div[3]/div[1]/div/div/table/tbody[1]/tr[1]/td[1]/ul/li/p"))
														.getText();
												if (GetAmount_Titile11.equals(GetAmount_Titile42)) {

													System.out.println(GetAmount_Titile42 + ":- PASS");
													test.log(LogStatus.PASS, "Quantity:- " + GetAmount_Titile42);

												} else {
													System.err.println(GetAmount_Titile42 + ":- FAIL");
													test.log(LogStatus.FAIL, "Quantity:- " + GetAmount_Titile42);

												}

												String GetAmount_Titile42A = driver
														.findElement(By.xpath(
																"//*[@id='ID_DeclarationForm_ExercisedQuantity']"))
														.getText();
												System.out
														.println(GetAmount_Titile11A + "-" + GetAmount_Titile42A);

												if (GetAmount_Titile11A.equals(GetAmount_Titile42A)) {

													System.out.println(GetAmount_Titile42A + ":- PASS");
													test.log(LogStatus.PASS, "Quantity:- " + GetAmount_Titile42A);

												} else {
													System.err.println(GetAmount_Titile42A + ":- FAIL");
													test.log(LogStatus.FAIL, "Quantity:- " + GetAmount_Titile42A);

												}
												Thread.sleep(100);

												// Exercise Amount
												String GetAmount_Titile43 = driver.findElement(By.xpath(
														"//*[@id='kt_content']/div/kt-excercise-stock-payment1-iii/div[2]/div/div[3]/div[1]/div/div/table/tbody[1]/tr[2]/td[1]/ul/li/span/span"))
														.getText();
												if (GetAmount_Titile12.equals(GetAmount_Titile43)) {

													System.out.println(GetAmount_Titile43 + ":- PASS");
													test.log(LogStatus.PASS, " Exercise Amount:- " + GetAmount_Titile43);

												} else {
													System.err.println(GetAmount_Titile43 + ":- FAIL");
													test.log(LogStatus.FAIL, " Exercise Amount:- " + GetAmount_Titile43);

												}

												String GetAmount_Titile43A = driver
														.findElement(By
																.xpath("//*[@id='ID_DeclarationForm_ExercisedAmount']"))
														.getText();

												if (GetAmount_Titile12A.equals(GetAmount_Titile43A)) {

													System.out.println(GetAmount_Titile43A + ":- PASS");
													test.log(LogStatus.PASS, " Exercise Amount:- " + GetAmount_Titile43A);

												} else {
													System.err.println(GetAmount_Titile43A + ":- FAIL");
													test.log(LogStatus.FAIL, " Exercise Amount:- " + GetAmount_Titile43A);

												}
												Thread.sleep(100);

												// Tax Amount
												String GetAmount_Titile44 = driver.findElement(By.xpath(
														"//*[@id='kt_content']/div/kt-excercise-stock-payment1-iii/div[2]/div/div[3]/div[1]/div/div/table/tbody[1]/tr[3]/td[1]/ul/li/a/p/span"))
														.getText();
												String string9 = new String(GetAmount_Titile13);
												String string10 = new String(GetAmount_Titile44);

												if (string9.equals(string10)) {

													System.out.println(GetAmount_Titile44 + ":- PASS");
													test.log(LogStatus.PASS, " Tax Amount:- " + GetAmount_Titile44);

												} else {
													System.err.println(GetAmount_Titile44 + ":- FAIL");
													test.log(LogStatus.FAIL, " Tax Amount:- " + GetAmount_Titile44);

												}

												String GetAmount_Titile44A = driver
														.findElement(
																By.xpath("//*[@id='ID_DeclarationForm_TaxAmount']"))
														.getText();
												String string11 = new String(GetAmount_Titile13A);
												String string12 = new String(GetAmount_Titile44A);
												System.out
														.println(GetAmount_Titile13A + "-" + GetAmount_Titile44A);

												if (string11.equals(string12)) {

													System.out.println(GetAmount_Titile44A + ":- PASS");
													test.log(LogStatus.PASS, " Tax Amount:- " + GetAmount_Titile44A);

												} else {
													System.err.println(GetAmount_Titile44A + ":- FAIL");
													test.log(LogStatus.FAIL, " Tax Amount:- " + GetAmount_Titile44A);

												}
												Thread.sleep(100);

												// Total Amount Payable
												String GetAmount_Titile45 = driver.findElement(By.xpath(
														"//*[@id='kt_content']/div/kt-excercise-stock-payment1-iii/div[2]/div/div[3]/div[1]/div/div/table/tbody[2]/tr/td[1]/span/span"))
														.getText();
												if (GetAmount_Titile14.equals(GetAmount_Titile45)) {

													System.out.println(GetAmount_Titile45 + ":- PASS");
													test.log(LogStatus.PASS, " Total Amount Payable:- " + GetAmount_Titile45);

												} else {
													System.err.println(GetAmount_Titile45 + ":- FAIL");
													test.log(LogStatus.FAIL, " Total Amount Payable:- " + GetAmount_Titile45);

												}
												
												String GetAmount_Titile45A = driver
														.findElement(By.xpath(
																"//*[@id='ID_DeclarationForm_TotalAmntPayable']"))
														.getText();
												if (GetAmount_Titile14A.equals(GetAmount_Titile45A)) {

													System.out.println(GetAmount_Titile45A + ":- PASS");
													test.log(LogStatus.PASS, " Total Amount Payable:- " + GetAmount_Titile45A);

												} else {
													System.err.println(GetAmount_Titile45A + ":- FAIL");
													test.log(LogStatus.FAIL, " Total Amount Payable:- " + GetAmount_Titile45A);
												...
												System.out
														.println("Acknowledgment_Payment  =" + Acknowledgment_Payment);
												if (Acknowledgment_Payment == true) {
													...
													if (Payment_checkbox == true) {
														...
														test.log(LogStatus.PASS,
																"Click on the Payment checkbox Button :-"
																		+ Payment_checkbox);

														Thread.sleep(1000);
														Boolean ExercisedSubmitDownload1 = driver
																.findElements(By.id(
																		"ID_DeclarationForm_ExercisedSubmitDownload"))
																.size() != 0;
														System.out.println("ExercisedSubmitDownload = "
														...
														if (ExercisedSubmitDownload1 == true) {
															...
															Boolean Acknowledgement_IntiateExercise1 = driver
																	.findElements(
																			By.id("ID_Acknowledgement_IntiateExercise"))
																	.size() != 0;
												...
												test.log(LogStatus.FAIL,
														"Test Case Failed- Quantity_MessageText Fails :-"
																+ Exerciese_Options);
					...
					test.log(LogStatus.FAIL,
							"Test Case Failed- Sorry Quantity this field is disable :-" + Exerciese_Options);
					Thread.sleep(500);
				...
				System.err.println("Phantom Units not available");
				test.log(LogStatus.FAIL, "Test Case Failed- Phantom Units not available :-" + Exerciese_Options);
				Thread.sleep(500);
